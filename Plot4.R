...
Plot4<-function()
{
    ...
    plot(data$DateTime,data$Global_active_power, pch=".", xlab="datetime",
         ylab="Global_reactive_power",type="n")
    lines(data$DateTime, data$Global_active_power,type="l")

    plot(data$DateTime,data$Voltage, pch=".", xlab="datetime",
         ylab="Voltage",type="n")
    ...
    plot(data$DateTime,data$Global_reactive_power, pch=".", xlab="datetime",
         ylab="Global_reactive_power",type="n")
